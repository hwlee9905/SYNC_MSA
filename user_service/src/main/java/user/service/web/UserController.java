...
public class UserController {
	...
	@Operation(summary = "현재 로그인 유저 정보를 가져오는 API")
	@GetMapping("info/v1")
	@LogAop
	public SuccessResponse getCurrentUserInfo(){
		return userService.getUserInfo();
	}
	@Operation(summary = "유저들의 정보를 가져오는 API")
	@GetMapping("info/v2")
	@LogAop
	...
	@Operation(summary = "유저의 비밀번호를 변경하는 API")
	@PutMapping("pwd")
	@LogAop
	...
	@Operation(summary = "유저의 정보를 변경하는 API", description = "ValidationDetails : ModifyUserInfoRequestDto")
	@PutMapping("info")
	@LogAop
