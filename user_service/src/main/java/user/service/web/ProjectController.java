...
public class ProjectController {
    ...
    @LogAop
    public ResponseEntity<SuccessResponse> updateProject(@RequestPart("data") @Valid UpdateProjectRequestDto updateProjectRequestDto, @RequestPart(value = "thumbnailImage", required = false) MultipartFile img) {
